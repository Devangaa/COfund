...
use App\Http\Controllers\Api\Backer\BackerStatisticsController;
use App\Http\Controllers\Api\CampaignController;
use App\Http\Controllers\Api\CampaignImageController;
use App\Http\Controllers\Api\CampaignUpdateController;
use App\Http\Controllers\Api\Creator\CreatorStatisticsController;
...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'role:creator', 'verified'])->group(function () {
        ...
        Route::get("/creator/statistics", [CreatorStatisticsController::class, "index"])->name("creator.statistics");
    });
...
// Email verification routes (outside v1 prefix for Laravel compliance)
