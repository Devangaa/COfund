...
<template>
  <div class="space-y-20 pb-20">
      ...
      <div class="max-w-7xl mx-auto relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-800/90 border border-slate-700/80 text-xs font-semibold text-sky-300 backdrop-blur-md">
              <span class="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
              Platform Crowdfunding FinTech Terpercaya dengan Virtual Escrow
            </div>

            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-tight sm:leading-tight text-white">
            ...
            <p class="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
              Dukung proyek teknologi inovatif, aksi kemanusiaan, dan karya kreatif Indonesia. Seluruh dana terlindungi aman di virtual escrow dengan jaminan pengembalian 100% jika target tidak tercapai.
            </p>

            <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              <RouterLink
                to="/campaigns"
                class="w-full sm:w-auto px-8 py-4 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm text-center transition-all duration-300 shadow-glow-blue flex items-center justify-center gap-2 group active:scale-[0.98]"
              >
              ...
              <RouterLink
                ...
                class="w-full sm:w-auto px-8 py-4 rounded-2xl bg-slate-800/90 hover:bg-slate-700/90 text-slate-200 font-bold text-sm text-center border border-slate-700 transition flex items-center justify-center gap-2 active:scale-[0.98]"
              >
          ...
          <div class="lg:col-span-5">
            <div class="relative mx-auto max-w-md bg-gradient-to-b from-slate-800/90 to-slate-900/95 p-6 sm:p-7 rounded-3xl border border-slate-700/90 shadow-2xl backdrop-blur-xl space-y-6">
              <div class="flex items-center justify-between">
                ...
                <span class="text-xs px-2.5 py-0.5 rounded-full bg-emerald-950 text-emerald-400 border border-emerald-800 font-semibold">
                  Live Status
                </span>
              </div>
              ...
              <div class="grid grid-cols-2 gap-3 text-left">
                <div class="p-3.5 rounded-xl bg-slate-800/60 border border-slate-700/60">
                  <div class="text-xs text-slate-400">Tingkat Sukses</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-20">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 sm:p-8 bg-white rounded-3xl border border-slate-200/80 shadow-soft">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        <RouterLink
          ...
          class="p-5 rounded-2xl bg-white border border-slate-200/80 hover:border-blue-500 hover:shadow-elevated transition-all duration-300 text-center flex flex-col items-center justify-center group hover:-translate-y-1"
        >
          <div class="w-12 h-12 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mb-3 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 shadow-sm">
    ...
    <section class="bg-slate-900 text-white py-16 px-4 sm:px-6 lg:px-8 rounded-3xl max-w-7xl mx-auto relative overflow-hidden border border-slate-800">
      <div class="text-center max-w-2xl mx-auto mb-12">
        ...
        <h2 class="text-2xl sm:text-3xl font-black text-white mt-1">
          Bagaimana CoFund Melindungi Dana Anda?
        </h2>
        <p class="text-xs sm:text-sm text-slate-300 mt-2">
          Sistem Virtual Escrow terotomasi menjamin dana tidak berpindah ke inisiator sebelum target tercapai.
        </p>
      </div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 rounded-3xl p-8 sm:p-12 text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-elevated">
        ...
        <RouterLink
          ...
          class="px-8 py-4 rounded-2xl bg-white text-blue-700 hover:bg-blue-50 font-bold text-sm transition shadow-md flex-shrink-0 active:scale-[0.98]"
        >
